...
<form action="/search" method="POST">
  ...
  <div class="product-container">
    <img src="{{source}}" alt="Cake" class="product-image">
    <div class="product-info">
      ...
      <!---<div class="product-options">
        <label for="eggless">Make it eggless</label>
        <input type="checkbox" id="eggless" value="50">
        <label for="less-sugar">Make in less sugar</label>
        <input type="checkbox" id="less-sugar" value="100">

        <input type="checkbox" id="heart-shape" value="100">
      </div>--->
 <form action="/placeorder" method="post">

       <div class="button-container">
                   <p>Cake weight:</p>
        <input  type="radio" name='kilo' value="1/2 kg" required>1/2 Kg</input>

        <input  type="radio"  name='kilo' value="1 kg" required>1 Kg</input>

        <input type="radio" name='kilo' value="2 kg" required>2 Kg</input>
            <br>
           <br>
           <div class="product-price">
        <span class="original-price">{{prize}}</span>

        <span class="discounted-price">₹449 (22% OFF)</span>
      </div>
        <button value='p1' name='put'>BUY NOW</button>
           <br>
           <br>
           <h6 >Indulge in perfection with our exquisite cakes, where every slice is a celebration of taste and quality!</h6>
