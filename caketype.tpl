...
<button  type="submit"  class="sr" name="done" value="ai"><i class="fa-solid fa-magnifying-glass" ></i></button>
  ...
  <section class="products" id="products" >
    ...
    <div class="box-container">
      ...
      <div class="box" >
        <img src="https://wallpapers.com/images/hd/all-cartoon-characters-1920-x-1200-a6onb3jao18sompt.jpg" alt="">
        <h3>CARTOON CAKES</h3>
        <button class="bt" value="bt1" name="buttons">CLICK HERE </button>


      </div>
      <div class="box">
        <img src="https://img.freepik.com/premium-photo/collection-musical-instruments-including-one-instruments_662214-63334.jpg" alt="">
        <h3>MUSICIAN CAKES</h3>
<button class="bt" value="bt2" name="buttons">CLICK HERE </button>

      </div>
      <div class="box">
        <img src="https://www.imural.id/en/blog/wp-content/uploads/2018/08/17-e1533625446402.jpg" alt="">
        <h3>PAINTER CAKES</h3>
<button class="bt" value="bt3" name="buttons">CLICK HERE </button>
    ...
    <div class="box-container">
      ...
      <div class="box">
        <img src="https://m.media-amazon.com/images/I/71I1RUXlL+L.jpg" alt="">
        <h3>MAKEUP CAKES</h3>
        <button class="bt" value="bt4" name="buttons">CLICK HERE </button>

      </div>
      <div class="box">
        <img src="https://img.freepik.com/premium-vector/cartoon-kids-professional-uniform-doctor-children-outfit-businessman-kid-baby-engineer-worker-set_102902-1837.jpg" alt="">
        <h3>EDUCATION PROFESSION CAKES</h3>
       <button class="bt" value="bt5" name="buttons">CLICK HERE </button>


      </div>
      <div class="box">
        <img src="https://media.istockphoto.com/id/1355687160/photo/various-sport-equipment-gear.jpg?s=612x612&w=0&k=20&c=NMA7dXMtGLJAin0z6N2uqrnwLXCRCXSw306SYfS49nI=" alt="">
        <h3> SPORTS </h3>
<button class="bt" value="bt6" name="buttons">CLICK HERE </button>
      </div>
    </div>
