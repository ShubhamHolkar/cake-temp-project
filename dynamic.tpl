...
<button  type="submit"  class="sr" name="done" value="ai"><i class="fa-solid fa-magnifying-glass"></i></button>
  ...
  <section class="products" id="products">
    ...
    <div class="box-container">
      ...
      <div class="box">
        <img src="{{source1}}" class="product-image" alt="">
        <button class="bt" value="b73" name="button" >BUY NOW</button>


      </div>

      <div class="box">
        <img src="{{source2}}" class="product-image" alt="">
       <button class="bt" value="b74" name="button" >BUY NOW</button>
       </div>

<div class="box">

    <img src="{{source3}}" class="product-image" alt="">
       <button class="bt" value="b75" name="button" >BUY NOW</button>
       </div>


      <div class="box">
        <img src="{{source4}}" class="product-image" alt="">
        <button class="bt" value="b76" name="button" >BUY NOW</button>
      </div>
    </div>

    <div class="box-container">
      <div class="box">
<img src="{{source5}}" class="product-image" alt="">
        <button class="bt" value="b77" name="button" >BUY NOW</button>


      </div>

      <div class="box">
<img src="{{source6}}" class="product-image" alt="">

       <button class="bt" value="b78" name="button" >BUY NOW</button>
       </div>

<div class="box">
<img src="{{source7}}" class="product-image" alt="">
       <button class="bt" value="b79" name="button" >BUY NOW</button>
       </div>


      <div class="box">
<img src="{{source8}}" class="product-image" alt="">
        <button class="bt" value="b80" name="button" >BUY NOW</button>
    ...
    <div class="box-container">
      ...
      <div class="box">
<img src="{{source9}}" class="product-image" alt="">
       <button class="bt" value="b81" name="button" >BUY NOW</button>


      </div>
      <div class="box">
        <img src="{{source10}}" class="product-image" alt="">

        <button class="bt" value="b82" name="button" >BUY NOW</button>


      </div>
      <div class="box">
        <img src="{{source11}}" class="product-image" alt="">

        <button class="bt" value="b83" name="button" >BUY NOW</button>


      </div>
      <div class="box">
        <img src="{{source12}}" class="product-image" alt="">

       <button class="bt" value="b84" name="button" >BUY NOW</button>
