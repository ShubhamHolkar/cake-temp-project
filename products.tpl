...
<button  type="submit"  class="sr" name="done" value="ai"><i class="fa-solid fa-magnifying-glass" ></i></button>
    ...
    <nav class="navbar">
      ...
      <ul>
        ...
        <li><button  value="log2" name="butt">Cakes </button> </li>
...
<li><button  value="log5" name="butt">Login </button> </li>
  ...
  <section class="products" id="products" >
    ...
    <div class="box-container">
      ...
      <div class="box" >
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSuHRMA-WBJOC5DN5SkWJIStZqGROjSHBDpEg&usqp=CAU" alt="">
        <h3>CAKES</h3>
        <p>"Delight in Every Bite with Delisios Cakes!"</p>
        <button class="bt" value="b1" name="button_clicked">CLICK HERE </button>


      </div>
      <div class="box">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRipJupNW-py-umct0D9gDddtlGQXO4gyU2tA&usqp=CAU" alt="">
        <h3>PASTRIES</h3>
<p>"Pastries that Melt Away in Every Exquisite Layer."</p>
<button class="bt" value="b2" name="button_clicked">CLICK HERE </button>

      </div>
      <div class="box">
        <img src="https://img.freepik.com/free-photo/delicious-cookies-arrangement_23-2150707167.jpg" alt="">
        <h3>COOKIES</h3>
<p>"Cookies that Crumble with Delight in Every Bite!"</p>
<button class="bt" value="b3" name="button_clicked">CLICK HERE </button>
    ...
    <div class="box-container">
      ...
      <div class="box">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcThM175Wt6KTUW8VE0hc10DGcG2zGf3c5VfFyiJdRcx_55YACJGuC10QaAlgOPz4GOKkas&usqp=CAU" alt="">
        <h3>DONUTS</h3>
        <p>""Experience Bliss in Every Donut Bite!""</p>
        <button class="bt" value="b4" name="button_clicked">CLICK HERE </button>

      </div>
      <div class="box">
        <img src="https://qph.cf2.quoracdn.net/main-qimg-8e02128bcb0744c0360cc57b8c690f4e-lq" alt="">
        <h3>CHOCOLATS</h3>
        <p>"Chocolate: Pure Joy in Every Bite"</p>
       <button class="bt" value="b5" name="button_clicked">CLICK HERE </button>


      </div>
      <div class="box">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcR8J5JyPAVgNFjVTI-wu7q7sgxH1tr6VUFtOQ&usqp=CAU" alt="">
        <h3>& MANY MORE</h3>
<p>"Endless Temptations and Many More "</p>
<button class="bt" value="b6" name="button_clicked">CLICK HERE </button>
      </div>
    </div>
