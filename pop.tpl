...
<body>
  ...
  <div class="product-container">
      ...
      <div class="product-options">
        ...
        <button class="bt" type="button">1/2 Kg</button>

        <button class="bt" type="button">1 Kg</button>

        <button class="bt" type="button">2 Kg</button>
        ...
        <p>Deliver To:</p>
        <input type="text" id="pincode" placeholder="Enter Address">
        <p>Place Order:</p>
        <button class="bt" type="button">Pay Online</button>
        ...
        <button class="bt" type="button">Cash on Delivery</button>
